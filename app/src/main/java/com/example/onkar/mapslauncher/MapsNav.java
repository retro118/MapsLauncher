...
public class MapsNav extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private static final String TAG = "MapsNav";
    ...
    private void geoLocate() {
        ...
        Geocoder geocoder = new Geocoder(MapsNav.this);
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            ...
                            moveCamera(new LatLng(currentLocation.getLatitude(), currentLocation.getLongitude()),
                                    DEFAULT_ZOOM,
                                    "My Location");
                            laf=currentLocation.getLatitude();
                            lof=currentLocation.getLongitude();

                        } else {
                            Log.d(TAG, "onComplete: current location is null");
                            Toast.makeText(MapsNav.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void moveCamera(LatLng latLng, float zoom, PlaceInfo placeInfo) {
        ...
        mMap.setInfoWindowAdapter(new CustomInfoWindowAdapter(MapsNav.this));
    ...
    private void initMap() {
        ...
        mapFragment.getMapAsync(MapsNav.this);
    }
